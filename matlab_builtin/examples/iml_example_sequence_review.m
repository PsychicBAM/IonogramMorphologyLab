function result = iml_example_sequence_review(varargin)
        % IML_EXAMPLE_SEQUENCE_REVIEW
...
if nargin && isnumeric(varargin{1}), frame=varargin{1}; else
        ...
        result=struct('validation',validation,'trace',trace,'layer',layer); iml_register_candidate_result('iml_example_sequence_review','example','Synthetic demonstration completed.');
        end
